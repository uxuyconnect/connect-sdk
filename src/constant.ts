...
export const walletLogo = (type = "square") => {
...
export const AppInfo = {
  ...
  logo: walletLogo(),
  description: 'The first Self-Custody Multi-Chain Wallet based on Telegram, crafted by the @uxuycom team 🧑‍🤝‍🧑',
  downloadLinks: {
    android: 'https://download.uxuy.com/v0.1/uxuy-release.apk',
    googlePlay:
      'https://play.google.com/store/apps/details?id=com.uxuySdk.wallet',
