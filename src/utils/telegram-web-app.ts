  ...
  function postEvent(eventType, callback, eventData) {
    ...
    if (window.TelegramWebviewProxy !== undefined) {
      ...
      try {
        ...
        trustedTarget = '*';
        console.log('[Telegram.WebView] > postEvent isIframe postMessage', eventType, eventData);
        window.parent.postMessage(JSON.stringify({eventType: eventType, eventData: eventData}), trustedTarget);
        callback();
      } catch (e) {
        console.error('[Telegram.WebView] > postEvent isIframe postMessage failed', e);
        callback(e);
      }
    }
    else {
      console.log('[Telegram.WebView] > postEvent default fallback', eventType, eventData);
...
// console.log("WebView loaded.....", Telegram.WebView)